# purpose:  Shared table utilities for building and saving formatted result tables.
#           Provides build_wide_ci_table(), make_table_plot(), save_table_jpg(),
#           estimate_table_dims(), and to_title_case().
# called by: table_model_shift_results.R, table_model_trend_results.R
